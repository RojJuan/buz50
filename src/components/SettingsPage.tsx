  ...
  return (
    <div className="p-6 bg-gray-100 min-h-screen flex flex-col items-center">
      ...
      <div className="flex space-x-4 mb-6">
        ...
        >
          {showSettings ? 'Hide Timer/Round Settings' : 'Show Timer/Round Settings'}
        </button>
        <button 
      ...
      {activeSetting === 'selfJoin' && (
        <div className="p-4 bg-white shadow rounded w-full max-w-md mb-4">
          <h2 className="text-xl font-semibold mb-2">Self Join Teams Settings</h2>
        </div>
      )}

      {activeSetting === 'earlyBuzz' && (
        <div className="p-4 bg-white shadow rounded w-full max-w-md mb-4">
          <h2 className="text-xl font-semibold mb-2">Early Buzz Penalty Settings</h2>
        </div>
      )}
